...
<div class="page-header">
    <div>
        <h2><i class="bi bi-truck me-2" style="color:var(--blue-500);"></i>Nouveau Fournisseur</h2>
        <p>Remplissez le formulaire pour ajouter un fournisseur</p>
    </div>
        ...
        <form action="{{ route('fournisseurs.store') }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label>Code Fournisseur <span class="required-star">*</span></label>
                    <input type="text" name="id" value="{{ old('id') }}"
                           class="form-control-custom @error('id') is-invalid @enderror"
                           placeholder="Ex: F001" readonly disabled>
                    @error('id')
            ...
            <div class="form-group">
                ...
                <input type="text" name="personne_contact" value="{{ old('personne_contact') }}"
