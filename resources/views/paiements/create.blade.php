...
@section('title', 'Nouveau Paiement - Sofrebak')
...
<div class="page-header">
    <div class="page-header-left">
        <h2><i class="bi bi-plus-circle-fill me-2" style="color:var(--blue-500);"></i>Nouveau Paiement</h2>
        <p>Enregistrez un nouveau paiement client</p>
    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="montant" step="0.01" min="0" class="form-control @error('montant') is-invalid @enderror" placeholder="0.00" value="{{ old('montant') }}" required>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3" placeholder="Commentaires ou détails supplémentaires..." required>{{ old('notes') }}</textarea>
                    ...
                    <div class="col-12 mt-4 text-end">
                        ...
                        <button type="submit" class="btn btn-submit">
                            <i class="bi bi-check-lg me-1"></i> Créer le Paiement
                        </button>
                    </div>
                </div>
            </form>
