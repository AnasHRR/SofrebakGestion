...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="form-card">
                <form action="{{ route('retours.update', $retour->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir enregistrer les modifications ?');">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select name="commande_client_id" id="commande_client_id"
                                    class="form-select @error('commande_client_id') is-invalid @enderror" required>
                            ...
                            @error('commande_client_id') <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="quantite"
                                    ...
                                    value="{{ $retour->quantite }}" min="1" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select name="comptable_id" class="form-select @error('comptable_id') is-invalid @enderror"
                                    required>
                        ...
                        <div class="col-12 mt-4 text-end">
                            <a href="{{ route('retours.index') }}"
                                class="btn btn-light me-2 fw-bold px-4 border">Annuler</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const selectedProduitId = "{{ $retour->produit_id }}";

    function loadProduits(commandeId, preSelectedId = null) {
            ...
            .then(data => {
                ...
                if (data.length === 0) {
                    ...
                    data.forEach(produit => {
                        ...
                        if (preSelectedId && produit.id == preSelectedId) {
    ...
    if (commandeSelect.value) {
        loadProduits(commandeSelect.value, selectedProduitId);
    }
});
</script>
@endsection
