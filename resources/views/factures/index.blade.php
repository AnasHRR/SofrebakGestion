...
@section('content')
    ...
    <style>
        ...
        .badge-statut.partielle {
            background: #fff7ed;
            color: #ea580c;
            border: 1px solid #fed7aa;
        }

        .badge-statut.non-payee {
            background: #fef2f2;
            color: #ef4444;
            border: 1px solid #fecaca;
        }
    ...
    <div class="stats-bar">
        ...
        <div class="stat-chip">
            ...
            <div>
                <div class="stat-chip-value">{{ number_format($factures->sum('montant_total'), 2, ',', ' ') }} <span
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:0.5rem;">
                                    <div
                                        style="width:30px;height:30px;background:#eff6ff;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('factures.show', $facture->id) }}" class="btn-icon btn-icon-view"
                                        title="Détails">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>
                                    <a href="{{ route('factures.edit', $facture->id) }}" class="btn-icon btn-icon-edit"
                                        title="Modifier">
