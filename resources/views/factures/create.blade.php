...
<div class="page-header">
    <div class="page-header-left">
        ...
        <p>Créer une nouvelle facture pour une commande client</p>
    </div>
        ...
        <form action="{{ route('factures.store') }}" method="POST" id="createFactureForm">
            ...
            <div class="form-section">
                ...
                <div class="info-box">
                    ...
                    <p>Sélectionnez la commande client associée à cette facture. Le numéro de facture doit être unique.</p>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-input-wrapper">
                            ...
                            <select name="statut" id="statut"
                                ...
                                <option value="Impayée" {{ old('statut') == 'Non payée' ? 'selected' : '' }}>Non payée</option>
