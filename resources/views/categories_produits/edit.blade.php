...
<div class="page-header">
    <div>
        <h2><i class="bi bi-pencil-square me-2" style="color:var(--blue-500);"></i>Modifier la Catégorie</h2>
        <p>Modifiez les informations de la catégorie <strong>{{ $categories->nom }}</strong></p>
    </div>
...
<div class="form-card">
    ...
    <div class="form-card-body">
        <form action="{{ route('categories.update', $categories->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir enregistrer les modifications ?');">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nom" value="{{ old('nom', $categories->nom) }}"
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control-custom @error('description') is-invalid @enderror" 
                          rows="4" placeholder="Description de la catégorie">{{ old('description', $categories->description) }}</textarea>
                @error('description')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
